				...
				<div className="sidebar-div">
					...
					{this.state.isLoading ? (
						...
						<select
							...
							value={this.state.currrentCountry.Country}
				...
				<div className="sidebar-div">
					<p className="sidebar-cont-p">
						...
						{this.state.isLoading ? (
							...
							<span className="sidebar-num-cont">
								{this.state.currrentCountry.TotalConfirmed}
							</span>
						) : (
				...
				<div className="sidebar-div">
					<p className="sidebar-cont-p">
						...
						{this.state.isLoading ? (
							...
							<span className="sidebar-num-cont">
								{this.state.currrentCountry.NewConfirmed}
							</span>
						) : (
							<span className="sidebar-num-cont">Failed to Load</span>
						)}
				...
				<div className="sidebar-div">
					<p className="sidebar-cont-p">
						...
						{this.state.isLoading ? (
							...
							<span className="sidebar-num-cont">
								{this.state.currrentCountry.TotalDeaths}
							</span>
						) : (
							<span className="sidebar-num-cont">Failed to Load</span>
						)}
				...
				<div className="sidebar-div">
					<p className="sidebar-cont-p">
						...
						{this.state.isLoading ? (
							...
							<span className="sidebar-num-cont">
								{this.state.currrentCountry.NewDeaths}
							</span>
						) : (
							<span className="sidebar-num-cont">Failed to Load</span>
						)}
				...
				<div className="sidebar-div">
					<p className="sidebar-cont-p">
						...
						{this.state.isLoading ? (
							...
							<span className="sidebar-num-cont">
								{this.state.currrentCountry.TotalRecovered}
							</span>
						) : (
							<span className="sidebar-num-cont">Failed to Load</span>
						)}
				...
				<div className="sidebar-div">
					<p className="sidebar-cont-p">
						...
						{this.state.isLoading ? (
							...
							<span className="sidebar-num-cont">
								{this.state.currrentCountry.NewRecovered}
							</span>
						) : (
							<span className="sidebar-num-cont">Failed to Load</span>
						)}
